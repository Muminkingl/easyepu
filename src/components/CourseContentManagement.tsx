                              ...
                              .map(file => (
                                ...
                                >
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-4">
                                      <div className="w-10 h-10 bg-gradient-to-br from-indigo-600/80 to-indigo-500/80 rounded-lg flex items-center justify-center shadow-md">
                            ...
                            <div className="relative p-6 border border-indigo-700/60 rounded-2xl bg-indigo-900/40 backdrop-blur-sm">
                              ...
                              <div className="space-y-6">
                                ...
                                <div>
                                  ...
                                  <div className="relative">
                                    <Link2 className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-indigo-300" />
                                    <input
                                      type="url"
                                      value={newFileUrl}
                                      onChange={(e) => setNewFileUrl(e.target.value)}
                                      className="w-full pl-10 pr-4 py-3 bg-indigo-800/30 border border-indigo-700/50 rounded-xl text-indigo-100 placeholder-indigo-400/70 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
